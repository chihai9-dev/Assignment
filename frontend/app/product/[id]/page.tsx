        ...
        <div className="mb-6">
          ...
          <div className="flex gap-4">
            {(["S", "M", "L"] as const).map((size) => (
              <label
                key={size}
                className="flex items-center gap-2 cursor-pointer border p-3 rounded-lg bg-white hover:border-blue-500 has-[:checked]:border-blue-500 has-[:checked]:ring-1 has-[:checked]:ring-blue-500 transition"
              >
                <input
                  type="radio"
                  name="size"
                ...
                <span className="font-medium">
                  Size {size} (+{SIZE_PRICES[size].toLocaleString("vi-VN")}đ)
                </span>
              </label>
            ))}
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col gap-3">
            {Object.entries(TOPPING_PRICES).map(([topping, price]) => (
              <label
                key={topping}
                className="flex items-center gap-2 cursor-pointer border p-3 rounded-lg bg-white hover:border-blue-500 has-[:checked]:border-blue-500 transition"
              >
                <input
                  type="checkbox"
